...
$this->params['breadcrumbs'][] = ['label' => 'سیم کارت'];
$this->params['breadcrumbs'][] = $this->title;
\yii\web\YiiAsset::register($this);
?>
<div class="mobile-and-tablet-sim-card-view">
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                'attribute' => 'sim_card_type_id',
                'value' => function($model) {
                    return $model->sim_card_type_id ? $model->simCardType->title : '-';
                }
            ],
            [
                'attribute' => 'exchange',
