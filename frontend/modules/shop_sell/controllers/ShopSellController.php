...
/**
 * shopSellController implements the CRUD actions for shopSell model.
 */
class ShopSellController extends Controller
{
    ...
    /**
     * Lists all shopSell models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new ShopSellSearch();
    ...
    /**
     * Displays a single shopSell model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Updates an existing shopSell model.
    ...
    /**
     * Deletes an existing shopSell model.
    ...
    /**
     * Finds the shopSell model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return shopSell the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ShopSell::findOne($id)) !== null) {
            return $model;
        }
