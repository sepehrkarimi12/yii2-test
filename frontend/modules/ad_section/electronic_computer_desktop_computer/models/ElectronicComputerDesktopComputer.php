...
namespace frontend\modules\ad_section\electronic_computer_desktop_computer\models;
...
/**
 * This is the model class for table "{{%tbl_vehicle_car_classic}}".
 *
 * @property int $id
 * @property int $ad_id
 ...
 */
class ElectronicComputerDesktopComputer extends \yii\db\ActiveRecord
{
    ...
    {
        return '{{%tbl_electronic_computer_desktop_computer}}';
    }
