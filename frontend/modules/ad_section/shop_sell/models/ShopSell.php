...
namespace frontend\modules\ad_section\shop_sell\models;
...
/**
 * This is the model class for table "tbl_shop_sell".
 *
 * @property int $id
 * @property int $ad_id
 * @property int $area
 ...
 */
class ShopSell extends \yii\db\ActiveRecord
{
