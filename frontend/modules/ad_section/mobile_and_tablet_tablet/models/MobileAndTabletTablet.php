...
namespace frontend\modules\ad_section\mobile_and_tablet_tablet\models;
...
/**
 * This is the model class for table "tbl_mobile_and_tablet_tablet".
 *
 * @property int $id
 * @property int $ad_id
 ...
 * @property MobileAndComputerBrand $brand
 */
class MobileAndTabletTablet extends \yii\db\ActiveRecord
{
    ...
    {
        return 'tbl_mobile_and_tablet_tablet';
    }
