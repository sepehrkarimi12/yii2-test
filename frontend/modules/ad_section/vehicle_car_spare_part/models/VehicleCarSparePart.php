...
namespace frontend\modules\ad_section\vehicle_car_spare_part\models;
 ...
 */
class VehicleCarSparePart extends \yii\db\ActiveRecord
{
    ...
    {
        return '{{%tbl_vehicle_car_spare_part}}';
    }
