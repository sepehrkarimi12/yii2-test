...
namespace frontend\modules\ad_section\vehicle_boat_and_spare_part\models;
 ...
 */
class VehicleBoatAndSparePart extends \yii\db\ActiveRecord
{
    ...
    {
        return '{{%tbl_vehicle_boat_and_spare_part}}';
    }
