...
namespace frontend\modules\ad_section\electronic_computer_spare_part\models;
 ...
 */
class ElectronicComputerSparePart extends \yii\db\ActiveRecord
{
    ...
    {
        return '{{%tbl_electronic_computer_spare_part}}';
    }
