...
namespace frontend\modules\ad_section\office_sell\models;
...
/**
 * This is the model class for table "tbl_office_sell".
 *
 * @property int $id
 * @property int $ad_id
 * @property int $area
 ...
 */
class OfficeSell extends \yii\db\ActiveRecord
{
