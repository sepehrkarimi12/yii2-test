...
namespace frontend\modules\ad_section\industrial_sell\models;
...
/**
 * This is the model class for table "tbl_industrial_sell".
 *
 * @property int $id
 * @property int $ad_id
 * @property int $area
 ...
 */
class IndustrialSell extends \yii\db\ActiveRecord
{
