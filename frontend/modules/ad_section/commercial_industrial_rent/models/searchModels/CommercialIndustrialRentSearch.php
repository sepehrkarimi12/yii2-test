...
namespace frontend\modules\ad_section\commercial_industrial_rent\models\searchModels;
 ...
 */
class CommercialIndustrialRentSearch extends CommercialIndustrialRent
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = CommercialIndustrialRent::find();
