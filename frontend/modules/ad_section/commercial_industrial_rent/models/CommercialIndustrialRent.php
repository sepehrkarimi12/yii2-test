...
namespace frontend\modules\ad_section\commercial_industrial_rent\models;
 ...
 */
class CommercialIndustrialRent extends \yii\db\ActiveRecord
{
    ...
    {
        return 'tbl_commercial_industrial_rent';
    }
