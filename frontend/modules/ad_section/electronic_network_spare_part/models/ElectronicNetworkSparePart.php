...
namespace frontend\modules\ad_section\electronic_network_spare_part\models;
 ...
 */
class ElectronicNetworkSparePart extends \yii\db\ActiveRecord
{
    ...
    {
        return '{{%tbl_electronic_network_spare_part}}';
    }
