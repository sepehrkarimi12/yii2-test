...
namespace frontend\modules\ad_section\mobile_and_tablet_spare_part\models;
 ...
 */
class MobileAndTabletSparePart extends \yii\db\ActiveRecord
{
    ...
    {
        return '{{%tbl_mobile_and_tablet_spare_part}}';
    }
