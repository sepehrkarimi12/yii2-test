...
namespace frontend\modules\ad_section\commercial_other_sell\models;
...
/**
 * This is the model class for table "tbl_commercial_sell".
 *
 * @property int $id
 * @property int $ad_id
 * @property int $area
 ...
 */
class CommercialOtherSell extends \yii\db\ActiveRecord
{
    ...
    {
        return 'tbl_commercial_other_sell';
    }
    ...
    {
        return [
            [['ad_id', 'area', 'ad_type_id', 'ad_advertiser_id', 'room_count_id', 'created_year_id', 'deed'], 'integer'],
