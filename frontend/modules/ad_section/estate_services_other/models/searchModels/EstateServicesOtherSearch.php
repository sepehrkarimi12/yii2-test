...
namespace frontend\modules\ad_section\estate_services_other\models\searchModels;
 ...
 */
class EstateServicesOtherSearch extends EstateServicesOther
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = EstateServicesOther::find();
