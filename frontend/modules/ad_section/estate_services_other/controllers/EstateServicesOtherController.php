 ...
 */
class EstateServicesOtherController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new EstateServicesOtherSearch();
    ...
    {
        if (($model = EstateServicesOther::findOne($id)) !== null) {
            return $model;
        }
