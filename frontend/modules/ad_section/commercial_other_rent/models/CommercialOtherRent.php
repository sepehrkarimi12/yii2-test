...
namespace frontend\modules\ad_section\commercial_other_rent\models;
 ...
 */
class CommercialOtherRent extends \yii\db\ActiveRecord
{
    ...
    {
        return 'tbl_commercial_other_rent';
    }
