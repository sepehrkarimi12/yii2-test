 ...
 */
class FinanceAndLegalController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new FinanceAndLegalSearch();
    ...
    {
        if (($model = FinanceAndLegal::findOne($id)) !== null) {
            return $model;
        }
