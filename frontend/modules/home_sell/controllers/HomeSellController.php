...
/**
 * HomeSellController implements the CRUD actions for HomeSell model.
 */
class HomeSellController extends Controller
{
    ...
    /**
     * Lists all HomeSell models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new HomeSellSearch();
    ...
    /**
     * Displays a single HomeSell model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Updates an existing HomeSell model.
    ...
    /**
     * Deletes an existing HomeSell model.
    ...
    /**
     * Finds the HomeSell model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return HomeSell the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = HomeSell::findOne($id)) !== null) {
            return $model;
        }
