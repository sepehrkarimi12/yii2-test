...
/**
 * This is the model class for table "tbl_electronic_computer_laptop".
 *
 * @property int $id
 * @property int $ad_id
 ...
 */
class ElectronicComputerLaptop extends \yii\db\ActiveRecord
{
    ...
    {
        return 'tbl_electronic_computer_laptop';
    }
