...
$this->params['breadcrumbs'][] = ['label' => 'خودرو سواری'];
$this->params['breadcrumbs'][] = $this->title;
\yii\web\YiiAsset::register($this);
?>
<div class="vehicle-car-riding-view">
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                'attribute' => 'miles',
                'value' => function($model) {
                    return $model->miles ? $model->miles . ' کیلومتر' : '-';
                }
            ],
            [
                'attribute' => 'mobile',
            ...
            [
                'attribute' => 'color_id',
                'value' => function($model) {
                    return $model->color_id ? $model->color->title : '-';
                }
            ],
            [
