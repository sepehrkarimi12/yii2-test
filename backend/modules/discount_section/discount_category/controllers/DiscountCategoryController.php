...
namespace backend\modules\discount_section\discount_category\controllers;

use Yii;
use common\models\discount_section\models\DiscountCategory;
use common\models\discount_section\models\searchModels\DiscountCategory as DiscountCategorySearch;
